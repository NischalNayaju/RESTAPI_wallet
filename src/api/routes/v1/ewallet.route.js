...
router
    .route('/pay')
    /**
     * @api {post} v1/ewallet/pay eWallet Pay
     * @apiDescription Make payment to merchants
     * @apiVersion 1.0.0
     * @apiName Pay
     * @apiGroup eWallet
     * @apiPermission customer
     ...
     * @apiSuccess  {String}  transaction.id     Transaction's id
     * @apiSuccess  {Number}  transaction.accountNumber   Transaction's accountNumber
     * @apiSuccess  {String}  transaction.operation  Transaction's type of operation (deposit, withdrawal, transfer, fee, pay)
     * @apiSuccess  {Number}  transaction.amount     Transaction's amount
     * @apiSuccess  {Number}  transaction.reference     Transaction's reference
     * @apiSuccess  {Date}    transaction.createdAt      Timestamp
     * 
     ...
     * @apiError (Forbidden 403)     Forbidden        Only admins can create the data
     */
    .post(authorize(), validate(walletPay), controllerWallet.pay);
