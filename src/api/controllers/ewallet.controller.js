...
const payService = require('../services/payServices');
 ...
 * @public
 */
exports.getBalance = (req, res) => res.json(req.customer.transform());
...
exports.pay = async(req, res, next) => {
    try {
        const payResponse = await payService.pay(req.customer.accountNumber, req.body.amount);
